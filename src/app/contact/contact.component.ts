...
constructor(private fb:FormBuilder, private router: Router, private api: BillingService, private ngZone: NgZone){}
  ngOnInit(): void {
...
const backendMessage = err?.error?.message;
         if (backendMessage) {
            // Show toast if backend says email already exists
